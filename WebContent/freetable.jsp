			...
			<div class="container">
				...
				<div class="col-lg-6 col-md-5 col-sm-5 text-center fh5co-link-wrap">
					<ul data-offcanvass="yes">
						...
						<li class="active"><a href="#">Set Table Free</a></li>
					</ul>
				</div> 
			</div>
		</nav>
...
<div class="login-page">
  <div class="form">
    <form class="login-form" action="settablefree" method="post">
      <input type="text" name="tablenumber" placeholder="Enter Table Number" required />
      <button id="login_button" type="submit" >Set Free</button>
    </form>
  </div>
</div>
