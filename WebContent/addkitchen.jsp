			...
			<div class="container">
				...
				<div class="col-lg-6 col-md-5 col-sm-5 text-center fh5co-link-wrap">
					<ul data-offcanvass="yes">
						...
						<li class="active"><a href="#">Add Kitchen Staff</a></li>
...
<div class="signup-page">
  <div class="form">
    <form class="signup-form" action="Addkitchen" method="post">
      <label >Add New Kitchen Satff</label>  <br>  <br>  
      <input type="text" name="name" placeholder="Enter new Member's name" required />
      <input type="email" name="email" placeholder="Enter valid email" required />
      <input type="password" name="password" placeholder="Enter password here" required />
      <input type="text" name="contact" placeholder="Enter new Member's phonenumber" required /> 
      <input type="hidden" name="designation" value="kitchen" />
      <button id="login_button" type="submit" >Add New Kitchen Staff</button>
