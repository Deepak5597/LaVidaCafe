...
.button a {
  ...
  text-transform: uppercase;
	...
	<div id="fh5co-page" style="height:700px;background: rgba(0, 0, 0, 0.6);
  z-index: 4;">
...
<div class="signup-page">
  <div class="form">
    <form class="signup-form" action="FormRegisterServlet" method="post">
      ...
      <input type="text" name="contact" placeholder="Enter Your phonenumber" required /> 
