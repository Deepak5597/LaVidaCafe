			...
			<div class="container">
				...
				<div class="col-lg-6 col-md-5 col-sm-5 text-center fh5co-link-wrap">
					<ul data-offcanvass="yes">
						...
						<li class="active"><a href="#">Switch Person</a></li>
					</ul>
				</div> 
			</div>
		</nav>
...
<div class="login-page">
  <div class="form">
    <form class="login-form" action="switchperson" method="post">
      <input type="email" name="switch" placeholder="Enter Email Here" required />
      <input type="email" name="switchto" placeholder="Enter Email TO Switch" required />
      <button id="login_button" type="submit" >Switch Order</button>
    </form>
  </div>
</div>
